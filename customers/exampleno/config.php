...
// Upload path
$config['custom_upload_path'] = '/store/brandeasy/customers/no/'.$_SESSION['CUSTOMER_NAME'].'/_INBOX';
...
$mediabank_request_url = '/PORTAL/BROWSE.php'.
                            '?path=/store/brandeasy/customers/no/'.$_SESSION['CUSTOMER_NAME'].'/_MEDIABANK'.
                            '%26set_base_path=true'.
                            '%26additional_base_paths=/store/brandeasy/customers/no/'.$_SESSION['CUSTOMER_NAME'].'/_INBOX'.
                            '%26site=brandeasy';
